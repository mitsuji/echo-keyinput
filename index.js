...
//                if (c2 == 'e') kana = 'ゑ';
    ...
    function setCurrentKey(key) {
        let elemCurrentKey = document.getElementById("currentKey");
        elemCurrentKey.innerText = key;
        window.setTimeout(function(){
	    elemCurrentKey.innerText = "\u00A0";
        },500);
    }

    function setCurrentKana(kana) {
        let elemCurrentKana = document.getElementById("currentKana");
        elemCurrentKana.innerText = kana;
        window.setTimeout(function(){
	    elemCurrentKana.innerText = "\u00A0";
        },500);
    }
});
